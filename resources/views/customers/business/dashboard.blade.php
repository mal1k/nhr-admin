...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">
            <a href="{{ route('business.create') }}" class="btn btn-sm btn-light-primary">
                ...
                <!--end::Svg Icon-->Create business user</a>
        </div>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <div class="d-flex justify-content-start flex-column">
                                    <a href="#" class="text-dark fw-bolder mb-1 fs-6">{{ $user->id }}</a>
                                </div>
                            </div>
                        </td>
                        <td>
                            <a href="#" class="text-dark fw-bolder d-block mb-1 fs-6">{{ $user->name }}</a>
                        </td>
                        <td>
                            <a href="#" class="text-dark fw-bolder d-block mb-1 fs-6">{{ $user->email }}</a>
                        </td>
                        <td>
                            <a href="#" class="badge badge-light-primary fs-7 fw-bold">{{ $user->business }}</a>
                        </td>
                        <td class="text-end">
                            <form id="delete_user_{{ $user->id }}" method="POST" action="{{ route('users.destroy', $user) }}">
                                <a href="{{ route('users.edit', $user) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
