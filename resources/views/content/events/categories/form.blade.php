...
@section('content')
<div class="my-3">
  <a class="text-decoration-none text-dark" href="{{ route('event-categories.index') }}">
...
<form method="POST" enctype="multipart/form-data"
    @if ( isset($category) )
        action="{{ route('event-categories.update', $category) }}"
    @else
...
@isset ($category)
  <form class="col" method="POST" action="{{ route('event-categories.destroy', $category) }}">
      @csrf
      @method('DELETE')
