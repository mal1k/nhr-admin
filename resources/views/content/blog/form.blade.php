...
<div id="mainForm">
  ...
  <div class="row">
    <div class="col-8">
        ...
        <div class="mb-2 col-12">
            <button type="submit" class="btn btn-sm btn-primary">{{ isset($blog) ?  'Update' : 'Create' }}</button>
        </div>
    ...
    <div class="col-4">
        ...
        <div class="col-12">
            ...
            <div class="image-input image-input-outline" data-kt-image-input="true" style="">
                ...
                <div class="image-input-wrapper w-125px h-125px" @isset ($blog->image_logo) style="background-image: url({{ asset('/storage/' . $blog->image_logo) }})" @endisset></div>
                ...
                title="Change cover">
                    ...
                    <input name="image_logo_prev" id="image_logo_prev" type="hidden" value="{{ $blog->image_logo }}">
                    @endisset
                    <!--end::Inputs-->
                </label>
                <!--end::Edit button-->
        ...
        <div class="col-12">
            ...
            <div class="image-input image-input-outline" data-kt-image-input="true" style="">
                <!--begin::Image preview wrapper-->
                <div class="image-input-wrapper w-125px h-125px" @isset ($blog->image_cover) style="background-image: url({{ asset('/storage/' . $blog->image_cover) }})" @endisset></div>
                <!--end::Image preview wrapper-->
                ...
                title="Change cover">
                    ...
                    <input name="image_cover_prev" id="image_cover_prev" type="hidden" value="{{ $blog->image_cover }}">
                    @endisset
                    <!--end::Inputs-->
                </label>
                <!--end::Edit button-->
